...
<#macro latestPublications>
    <div class="card mb-4">
        <div class="card-header">Latest Publications</div>
        <div class="card-body">
            <ul class="list-unstyled">
                <#list published_publications[0..6] as publication>
                    <li class="mb-2">
                        <div class="title">
                            <a href="${content.rootpath}${publication.uri}">${publication.title}</a>
                        </div>
                        <div class="small">${publication.date?string("EEE d MMMM yyyy")}</div>
                        <@userBadgeInline userId=publication.author/>
                    </li>
                </#list>
                <div class="small float-end">
                    <a href="${content.rootpath}publications/index.html">Publication archive</a>
                </div>
            </ul>
        </div>
    </div>
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <ul class="list-unstyled">
                ...
                <div class="small float-end">
                    <a href="${content.rootpath}talks/index.html">Video archive</a>
                </div>
            </ul>
        </div>
    </div>
...
<#macro tryItButton>
    <div class="card bg-light mb-4">
        <div class="text-center mt-2"><a class="btn btn-lg btn-success versionedButton" href="${menu.github}"><img alt="Download" src="${content.rootpath}download/download.png">
            <div>
                <span>Try Academic Pages</span><br/>
            </div>
        </a></div>
        <div class="card-body">
            <ol class="mb-1">
                <li><code>git clone</code></li>
                <li><code>cd academicpages</code></li>
...
<#macro getStartedButton>
    <div class="card bg-light mb-4">
        <div class="text-center mt-2"><a class="btn btn-lg btn-primary versionedButton" href="${config.canonicalBaseUrl}/docs/{menu.projectUrl}/latest/quickstart/quickstart.html"><img alt="Documentation" src="${content.rootpath}learn/documentation.png">
            <div>
        ...
        <div class="card-body">
            <div class="text-center">
                <a href="${menu.github}"><i class="fab fa-github me-1 text-black"></i>Clone the Quickstarts code.</a>
            </div>
        </div>
    </div>
</#macro>
...
<#macro useCaseCards>
    <div class="row row-cols-2 row-cols-md-3 row-cols-lg-4 g-4">
        <@featureCard uri="learn/useCases/publications/"
                iconClass="fa-solid fa-book-journal-whills"
                title="Publications"
                description="Publications."/>
        <@featureCard uri="learn/useCases/talks/"
                iconClass="fa-regular fa-presentation-screen"
                title="Talks"
                description="Talks."/>
        <@featureCard uri="learn/useCases/teaching/"
                iconClass="fa-regular fa-person-chalkboard"
                title="Teaching"
                description="Teaching."/>
        <@featureCard uri="learn/useCases/blog/"
                iconClass="fa-regular fa-blog"
                title="Blog"
